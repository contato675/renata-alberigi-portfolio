...
const base='https://contato675.github.io/renata-alberigi-portfolio/';
...
const rootRobots=await fetch('https://contato675.github.io/robots.txt',{signal:AbortSignal.timeout(15000)});
